...
Console.ReadLine();*/
//Option B - classroom
string[] alumnos = { "Sophia", "Andrew", "Emma", "Logan", "Sixto", "Juana" };
...
new int[] { 97, 93, 87, 82, 86 }
};

if (alumnos.Length != notas.Length)
{
    if (alumnos.Length > notas.Length) {
        Console.WriteLine("Hay mas alumnos registrados que notas.");
    } else {
        Console.WriteLine("Hay mas notas registradas que alumnos.");
    }
}
else
{
    ...
    foreach (var alumno in alumnos)
    {
        ...
        var media = sumaDeValores / notas[indiceDeAlumno].Length;
        indiceDeAlumno++;
        sumaDeValores = 0;
